...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.dw = nn.Conv2d(planes, planes, kernel_size=3, stride=stride, padding=1, groups=planes, bias=False)
    ...
    def forward(self, x):
        ...
        out = self.conv2(self.dw(F.relu(self.bn2(out))))
        out += self.shortcut(x)
        return out
...
def resnet18(base_width, num_classes=10):
